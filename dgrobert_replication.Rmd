...
#this should match the first plot in fig s2:
plot(x=cf$Freq, y=tf$Freq)

#my maximums are too high, there is no way their figure represents the data they provided.  I realize the caption is vague and recall from the article text that they have another data set they did not provide.
